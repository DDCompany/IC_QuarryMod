...
declare namespace ChargeItemRegistry {
    ...
    function registerItem(id: number, energyType: string, capacity: number, transferLimit: number, tier: number,
                          canProvideEnergy?: boolean, notInCreative?: boolean): void;

    function registerFlashItem(id: number, energyType: string, amount: number, tier: number): void;

    /** @deprecated Use registerItem instead */
    function registerExtraItem(id: number, energyType: string, capacity: number, transferLimit: number, tier: number,
                               itemType?: string, addScale?: boolean, addToCreative?: boolean): void;
    ...
    function getEnergyFrom(item: ItemInstance, energyType: string, amount: number, tier: number,
                           getAll?: boolean): number;

    function getEnergyFromSlot(slot: ItemContainerSlot, energyType: string, amount: number, tier: number,
                               getAll?: boolean): number;

    function addEnergyTo(item: ItemInstance, energyType: string, amount: number, tier: number,
                         addAll?: boolean): number;

    function addEnergyToSlot(slot: ItemContainerSlot, energyType: string, amount: number, tier: number,
                             addAll?: boolean): number;
